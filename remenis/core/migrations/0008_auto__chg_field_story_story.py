...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Story.story'
        db.alter_column('core_story', 'story', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Story.story'
        db.alter_column('core_story', 'story', self.gf('django.db.models.fields.CharField')(max_length=500))
