...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.is_registered'
        db.add_column('core_user', 'is_registered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Story.is_private'
        db.add_column('core_story', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'StoryComment.comment'
        db.alter_column('core_storycomment', 'comment', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'User.is_registered'
        db.delete_column('core_user', 'is_registered')

        # Deleting field 'Story.is_private'
        db.delete_column('core_story', 'is_private')


        # Changing field 'StoryComment.comment'
        db.alter_column('core_storycomment', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))
