...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaggedUser.taggeduserid'
        db.add_column('core_taggeduser', 'taggeduserid',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaggedUser.taggeduserid'
        db.delete_column('core_taggeduser', 'taggeduserid_id')
