...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageView.page'
        db.alter_column('core_pageview', 'page', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'PageView.page'
        db.alter_column('core_pageview', 'page', self.gf('django.db.models.fields.CharField')(max_length=20))
