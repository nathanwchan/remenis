# Django settings for remenis project.
import socket
import os.path
 

if socket.gethostname() == 'Nathans-MacBook-Air.local' or socket.gethostname()== 'AKSLAPTOP':
    DEBUG = True
else:
    DEBUG = True
...
if DEBUG:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'C:/projects/remenis/remenis/remenis.db',                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'remenis.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'remenis.wsgi.application'
